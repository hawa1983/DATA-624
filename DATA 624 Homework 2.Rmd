...
boxcox_plot <- ggplot(canadian_gas, aes(x = Month, y = BoxCox_Volume)) +
  geom_line(color = "red") +
  labs(title = paste("Figure 2: Box-Cox Transformed Volume of Canadian Gas (λ =", round(lambda, 2), ")"), 
       x = "Month", 
...
ggplot(myseries_transformed, aes(x = Month, y = BoxCox_Turnover)) +
  geom_line(color = "blue") +
  labs(title = paste("Figure 2: Box-Cox Transformed Turnover (λ =", round(lambda, 2), ")"),
       x = "Month",
